...
const CUSTOMIZESORTBY_LOGGING = LOGGING && false;
                ...
                <div>
                    ...
                    {descriptionIsExpanded && (
                        <div>
                            ...
                            <p>
                                In the text box below, you can create a formula
                                for your own custom sorting method! Here are the
                                commands available.
                            </p>
                            <ul>
                                <li>
                                    ...
                                    <ul>
                                        <li>
                                            The parentheses will group things
                                            into one value. This is useful for
                                            separating values when trying to
                                            ensure an order of operations.
                                        </li>
                                    </ul>
                                </li>
                                <li>
                                    ...
                                    <ul>
                                        <li>
                                            This will average all
                                            space-separated values inside the
                                            parentheses. Note that more than one
                                            value is required.
                                        </li>
                                    </ul>
                                </li>
                                <li>
                                    ...
                                    <ul>
                                        <li>
                                            This will sum all space-separated
                                            values inside the parentheses. Note
                                            that more than one value is
                                            required.
                                        </li>
                                    </ul>
                                </li>
